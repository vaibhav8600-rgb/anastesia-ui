...
export const sensorSections = [
  {
    ...
    controls: [
      ...
      },
      {
        ...
        hero: true,
        hint: "Steadier aim, slightly more latency.",
        read: (s) => s.sma,
      ...
      cfg("ac/history_ttl", "Axis clamper history", { adv: "Axis handling", unit: " ms", advanced: true }),
      cfg("rrl/auto_off_ms", "Rate monitor auto-off", { adv: "Report rate", unit: " ms", advanced: true }),
      cfg("ah/timeout_ms", "Auto hold delay", { adv: "Auto hold", unit: " ms", advanced: true }),
      cfg("usb/quar_n", "USB quarantine size", { adv: "Connection", advanced: true }),
      cfg("esb/quar_n", "Dongle quarantine size", { adv: "Connection", advanced: true }),
    ],
  },
  {
    id: "scroll",
    ...
    controls: [
      ...
      toggle("p2sm/scroll_dis_ptr", "Lock pointer while scrolling", { adv: "Pointer interaction", advanced: true }),
      cfg("p2sm/ptr_after_scroll", "Pointer resume delay", { adv: "Pointer interaction", unit: " ms", advanced: true }),
      toggle("p2sm/twist_global_en", "Twist scroll available", { adv: "Pointer interaction", advanced: true }),
      // Both spellings exist across firmware revisions; the absent one hides.
      cfg("p2sm/twist_dy_mag_mul", "Twist/translation multiplier", { adv: "Detection", advanced: true }),
      cfg("p2sm/twist_dy_mag_div", "Twist/translation divisor", { adv: "Detection", advanced: true }),
      cfg("p2sm/dy_mag_mul", "Twist/translation multiplier", { adv: "Detection", advanced: true }),
      cfg("p2sm/dy_mag_div", "Twist/translation divisor", { adv: "Detection", advanced: true }),
      toggle("p2sm/twist_hyst_en", "Twist hysteresis", { adv: "Hysteresis", advanced: true }),
      cfg("p2sm/twist_hyst_thres", "Hysteresis threshold", { adv: "Hysteresis", advanced: true }),
      cfg("p2sm/twist_hyst_mul", "Hysteresis multiplier", { adv: "Hysteresis", advanced: true }),
      cfg("p2sm/twist_hyst_div", "Hysteresis divisor", { adv: "Hysteresis", advanced: true }),
      cfg("p2sm/fb_dur", "Buzz length", { adv: "Haptics", unit: " ms", advanced: true }),
  ...
  },
  {
    ...
    controls: [
      ...
      cfg("ec11/debounce_ms", "Pulse debounce", { unit: " ms" }),
...
export const lightControls = [
  ...
  cfg("argb/bw2", "Battery warning 2", { adv: "Battery warnings", unit: "%", advanced: true }),
  cfg("argb/bw3", "Battery warning 3", { adv: "Battery warnings", unit: "%", advanced: true }),
  cfg("argb/bc1", "Critical warning 1", { unit: "%" }),
  cfg("argb/bc2", "Critical warning 2", { adv: "Battery warnings", unit: "%", advanced: true }),
  cfg("argb/bc3", "Critical warning 3", { adv: "Battery warnings", unit: "%", advanced: true }),
];
